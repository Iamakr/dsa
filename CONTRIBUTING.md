...
- Choose any task on [Leetcode](https://www.leetcode.com/), [Codechef](https://www.codechef.com/) or any other online platform and solve it, (or choose your already solved question)
...
```javascript
$ git remote add upstream https://github.com/Iamakr/dsa.git
```
